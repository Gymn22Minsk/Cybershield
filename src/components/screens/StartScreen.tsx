...
export function StartScreen({
  ...
  return (
    ...
    >
      <div className="absolute top-4 right-4 md:top-6 md:right-6 lg:top-8 lg:right-8 opacity-30 hover:opacity-100 transition-opacity select-none pointer-events-none">
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1.2, duration: 1 }}
          className="text-purple-500 font-mono text-[8px] md:text-[10px] tracking-[0.5em] uppercase border-r border-purple-500/50 pr-2 py-0.5"
        >
          #КиберПраво
        </motion.div>
      </div>
      ...
      <div className="space-y-2 md:space-y-3 text-center shrink-0 px-4">
        ...
        <div className="flex items-center justify-center gap-2 md:gap-4 text-zinc-500 font-mono text-[10px] sm:text-sm lg:text-base tracking-[0.3em] uppercase">
          ...
          Система активна // Республика Беларусь 2026
        </div>
        {highScore > 0 && (
          <motion.div
