...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    type: ScenarioType.SMS,
    sender: "MVD_BELARUS",
    content: "Внимание! Проводится акция 'КиберДети'. Узнайте, как защитить свой смартфон на официальном портале: https://mvd.gov.by/ru/news/17778",
    isPhishing: false,
...
export const NEW_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    dialogTree: [
      {
        id: 'start', speaker: 'scammer', text: "Здравствуйте! Служба безопасности ЕРИП. Задолженность 450 BYN - срочно погасите!", choices: [
          { id: 'c1', text: "Какая задолженность?", nextNodeId: 'c1_resp', points: 50 },
          { id: 'c2', text: "Пришлите ссылку для оплаты", nextNodeId: 'c2_trap', points: 0, isRisky: true },
  ...
  },
  {
    ...
    educationalInfo: {
      ...
      description: "Все государственные сайты Беларуси используют домен .gov.by. Любые дополнительные приставки после .gov.by — признак подделки.",
    }
  },
  {
    id: 106,
    ...
    dialogTree: [
      ...
      },
      {
        ...
        choices: [
          { id: 'd1a', text: "Это географическое определение неточно, но я проверю через официальноеприложение", nextNodeId: 'd1a_win', points: 90, revealsClue: true },
          { id: 'd1b', text: "О нет! Как защитить аккаунт?", nextNodeId: 'd1b_trap', points: 0, isRisky: true },
          { id: 'd1c', text: "Дайте номер вашего отдела, я проверю на Куфаре", nextNodeId: 'd1c_good', points: 70, revealsClue: true },
        ]
      },
      ...
      {
        id: 'd2_trap', speaker: 'scammer', text: "Конечно помогу! Переходите сюда: kufar-secure-verify.pw/auth - вводите пароль от аккаунта",
        choices: [
          { id: 'd2a', text: "СТОП! Это явно фишинговый домен! Обращусь в милицию!", nextNodeId: 'd2a_win', points: 100, revealsClue: true },
  ...
  },
  {
    ...
    content: "[Аудио]: 'Мам, это я. Я ехал на велосипеде и меня зацепил водитель, милиция требует деньги иначе вас посадят в тюрьму.'",
    audioUrl: "audio/son_scam.mp3",
    isPhishing: true,
  ...
  },
  {
    ...
    educationalInfo: {
      ...
      description: "В Республике Беларусь обмен валюты через неофициальные каналы запрещён. Используйте только банки и лицензированные пункты обмена.",
    }
  },
];
